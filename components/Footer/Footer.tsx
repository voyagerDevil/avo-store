      ...
      <Grid stackable>
        <Grid.Row>
          ...
          <Grid.Column width={7}>
            ...
            <p>
              <a href="https://github.com/voyagerDevil" target={'_blank'}>
                Fracis. React Frontend Developer
              </a>
              . Conoce más acerca de mí en Github o en mi{' '}
              <a href="https://francis.rf.gd/" target={'_blank'}>
                sitio web
              </a>
              .
            </p>
